...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_LAYER0] = LAYOUT_65_ansi_blocker( /* Base */
		    ...
		    KC_LCTL,       KC_LALT,  KC_LGUI,                KC_SPC,                MO(1),             KC_RCTRL, KC_LEFT,           KC_DOWN,   KC_RIGHT),
		[_LAYER1] = LAYOUT_65_ansi_blocker( /* FN */
		    ...
		    KC_TRNS,       KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_PSCR, KC_SLCK,  KC_PAUS, RESET,    KC_TRNS,\
			CTL_T(KC_CAPS),KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT,KC_TRNS,  KC_TRNS,          KC_TRNS,  KC_TRNS,\
